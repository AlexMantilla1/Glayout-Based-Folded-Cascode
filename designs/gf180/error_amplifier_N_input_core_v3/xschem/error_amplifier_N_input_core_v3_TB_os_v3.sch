...
print #####_Custom_output_##### Av BW BW_2 Rout gm_M1 ro_M1 gm_M6 ro_M6 ro_M4 gm_M8 ro_M8 ro_M10
    ...
    remzerovec
    write error_amplifier_N_input_core_v3_ac.raw
    set appendwrite
    ...
    *plot vout_phase
    ...
    write error_amplifier_N_input_core_v3_TB_os_v3.raw
.endc
"}
...
C {lab_pin.sym} 480 -420 2 1 {name=p6 sig_type=std_logic lab=VbiasP2}
C {lab_pin.sym} 480 -400 2 1 {name=p7 sig_type=std_logic lab=VbiasN2}
C {lab_pin.sym} 480 -380 2 1 {name=p11 sig_type=std_logic lab=VbiasN1}
...
C {gf180/error_amplifier_N_input_core_v3/xschem/error_amplifier_N_input_core_v3.sym} 530 -570 0 0 {name=x1}
