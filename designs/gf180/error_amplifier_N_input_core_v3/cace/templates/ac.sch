...
C {lab_pin.sym} 540 -490 2 1 {name=p6 sig_type=std_logic lab=VbiasP2}
C {lab_pin.sym} 540 -470 2 1 {name=p7 sig_type=std_logic lab=VbiasN2}
C {lab_pin.sym} 540 -450 2 1 {name=p11 sig_type=std_logic lab=VbiasN1}
...
.endc
"}
C {xschem/error_amplifier_N_input_core_v3.sym} 590 -640 0 0 {name=x1}
