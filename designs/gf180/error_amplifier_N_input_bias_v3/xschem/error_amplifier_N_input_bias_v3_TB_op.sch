...
P 4 1 360 -280 {}
P 4 1 360 -300 {}
T {710mV} 410 -240 0 0 0.4 0.4 {}
T {1.47V} 410 -270 0 0 0.4 0.4 {}
T {1.01V} 410 -300 0 0 0.4 0.4 {}
N 130 -60 130 -20 {
lab=GND}
N 130 -160 130 -120 {
lab=VSS}
...
C {devices/vsource.sym} 210 -90 0 0 {name=V2 value=3.3 savecurrent=false}
...
write error_amplifier_N_input_bias_v3_TB_op.raw
...
C {launcher.sym} 100 -360 0 0 {name=h2
descr="Annotate OP"
tclcommand="set show_hidden_texts 1; xschem annotate_op"}
C {gf180/error_amplifier_N_input_bias_v3/xschem/error_amplifier_N_input_bias_v3.sym} 200 -270 0 0 {name=x1}
