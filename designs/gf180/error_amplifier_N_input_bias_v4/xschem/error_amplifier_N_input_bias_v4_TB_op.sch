...
P 4 1 360 -280 {}
P 4 1 360 -300 {}
T {0.9V} 410 -240 0 0 0.4 0.4 {}
T {1.3V} 410 -270 0 0 0.4 0.4 {}
T {0.9V} 410 -300 0 0 0.4 0.4 {}
N 130 -60 130 -20 {
lab=GND}
N 130 -160 130 -120 {
lab=VSS}
...
write error_amplifier_N_input_bias_v4_TB_op.raw
...
C {gf180/error_amplifier_N_input_bias_v4/xschem/error_amplifier_N_input_bias_v4.sym} 200 -270 0 0 {name=x1}
