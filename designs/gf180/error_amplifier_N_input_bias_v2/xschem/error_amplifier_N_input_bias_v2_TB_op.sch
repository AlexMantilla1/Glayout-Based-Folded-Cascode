...
P 4 1 360 -280 {}
P 4 1 360 -300 {}
T {600mV} 400 -240 0 0 0.4 0.4 {}
T {1.21V} 410 -270 0 0 0.4 0.4 {}
T {580mV} 410 -300 0 0 0.4 0.4 {}
N 130 -60 130 -20 {
lab=GND}
N 130 -160 130 -120 {
lab=VSS}
...
write error_amplifier_N_input_bias_v2_TB_op.raw
...
C {gf180/error_amplifier_N_input_bias_v2/xschem/error_amplifier_N_input_bias_v2.sym} 200 -270 0 0 {name=x1}
