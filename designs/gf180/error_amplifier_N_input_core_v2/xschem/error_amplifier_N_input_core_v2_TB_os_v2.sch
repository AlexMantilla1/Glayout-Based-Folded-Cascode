...
N 590 -190 690 -190 {
lab=Vin}
N 460 -160 460 -130 {lab=VbiasP1}
N 460 -70 460 -60 {lab=GND}
...
C {devices/lab_wire.sym} 740 -10 0 0 {name=p4 sig_type=std_logic lab=VbiasN1}
C {devices/lab_wire.sym} 740 -30 0 0 {name=p5 sig_type=std_logic lab=VbiasN2}
C {devices/lab_wire.sym} 740 -50 0 0 {name=p6 sig_type=std_logic lab=VbiasP2}
...
.endc
"}
C {devices/vsource.sym} 460 -100 0 0 {name=Vsb1 value=\{VbiasP1\} savecurrent=false}
C {devices/gnd.sym} 460 -60 0 0 {name=l10 lab=GND}
C {devices/lab_wire.sym} 460 -160 0 0 {name=p13 sig_type=std_logic lab=VbiasP1
}
C {devices/lab_wire.sym} 740 -70 0 0 {name=p14 sig_type=std_logic lab=VbiasP1}
...
C {devices/lab_wire.sym} 720 -90 0 0 {name=p16 sig_type=std_logic lab=Vcom}
C {devices/vsource.sym} 750 -480 3 0 {name=V7 value=\{Vin_CM\}
}
C {gf180/error_amplifier_N_input_core_v2/xschem/error_amplifier_N_input_core_v2.sym} 790 -220 0 0 {name=x1}
