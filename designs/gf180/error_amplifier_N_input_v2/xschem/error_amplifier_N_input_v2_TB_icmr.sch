...
S {}
E {}
T {The measurerror_amplifier_N_input_v2ent for this test must be checked. 
...
However, measurerror_amplifier_N_input_v2ent is not okay today.
...
C {simulator_commands.sym} 380 -720 0 0 {name="COMMANDS"
simulator="ngspice"
only_toplevel="false" 
value="
.control
...
write error_amplifier_N_input_v2_TB_icmr.raw
...
.param Vout_CM = 0.9
"}
C {gf180/error_amplifier_N_input_v2/xschem/error_amplifier_N_input_v2.sym} 870 -290 0 0 {name=x1}
C {devices/launcher.sym} 240 -430 0 0 {name=h1
descr="Save & Netlist & sim" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {launcher.sym} 240 -380 0 0 {name=h2
descr="Annotate OP"
