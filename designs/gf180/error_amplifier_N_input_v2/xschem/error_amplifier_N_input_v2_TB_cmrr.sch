...
N 990 -340 990 -290 {
lab=Vout}
N 300 -100 300 -90 {lab=GND}
N 300 -190 300 -160 {lab=Vin}
N 600 -370 700 -370 {
lab=V-}
...
N 940 -340 940 -80 {lab=Vout}
N 830 -80 940 -80 {lab=Vout}
N 600 -310 600 -80 {lab=V-}
N 600 -80 770 -80 {lab=V-}
N 600 -370 600 -310 {lab=V-}
N 650 -310 700 -310 {lab=Vin}
N 700 -370 720 -370 {lab=V-}
N 700 -320 700 -310 {lab=Vin}
N 700 -320 720 -320 {lab=Vin}
N 380 -100 380 -90 {lab=GND}
N 380 -190 380 -160 {lab=Vref}
C {capa.sym} 650 -340 0 0 {name=C1
m=1
value=10G
footprint=1206
device="ceramic capacitor"}
C {ind.sym} 800 -80 1 0 {name=L4
m=1
value=10G
footprint=1206
device=inductor}
C {devices/code_shown.sym} 80 -590 0 0 {name=MODELS1 only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {devices/noconn.sym} 830 -280 0 1 {name=l6}
C {devices/lab_wire.sym} 790 -220 0 0 {name=p5 sig_type=std_logic lab=VSS}
...
C {devices/lab_wire.sym} 300 -190 0 0 {name=p7 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 990 -340 0 0 {name=p8 sig_type=std_logic lab=Vout}
C {devices/gnd.sym} 990 -170 0 0 {name=l9 lab=GND}
C {simulator_commands.sym} 770 -570 0 0 {name=COMMANDS2
simulator=ngspice
only_toplevel=false 
value="
.control
...
write error_amplifier_N_input_v2_TB_cmrr.raw
...
.endc
"}
C {devices/code_shown.sym} 540 -560 0 0 {name=Voltage_sources1 only_toplevel=true
value="
.param VDD = 1.8
.param VSS = 0
.param Vref = 1.2
...
C {devices/lab_wire.sym} 220 -190 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 600 -370 0 0 {name=p11 sig_type=std_logic lab=V-}
C {devices/lab_wire.sym} 650 -310 2 0 {name=p16 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 790 -260 0 0 {name=p17 sig_type=std_logic lab=Vref}
C {devices/vsource.sym} 380 -130 0 0 {name=V7 value=\{Vref\}}
C {devices/gnd.sym} 380 -90 0 0 {name=l14 lab=GND
value=\{Vref\}}
C {devices/lab_wire.sym} 380 -190 0 0 {name=p18 sig_type=std_logic lab=Vref
value=\{Vref\}}
C {gf180/error_amplifier_N_input_v2/xschem/error_amplifier_N_input_v2.sym} 810 -340 0 0 {name=x1}
C {devices/launcher.sym} 180 -480 0 0 {name=h1
descr="Save & Netlist & sim" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {launcher.sym} 180 -430 0 0 {name=h2
descr="Annotate OP"
