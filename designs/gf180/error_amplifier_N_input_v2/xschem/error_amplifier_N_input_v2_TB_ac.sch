...
N 840 -490 940 -490 {
lab=V-}
N 280 -210 280 -200 {lab=GND}
N 280 -300 280 -270 {lab=Vin}
N 840 -440 940 -440 {
lab=Vin}
N 130 -210 130 -200 {lab=GND}
N 130 -300 130 -270 {lab=VDD}
N 210 -210 210 -200 {lab=GND}
N 210 -300 210 -270 {lab=VSS}
N 670 -440 840 -440 {lab=Vin}
...
N 1160 -210 1160 -180 {lab=Vout}
N 1120 -140 1160 -140 {lab=GND}
N 1160 -140 1160 -80 {lab=GND}
N 1080 -80 1160 -80 {lab=GND}
N 1080 -130 1080 -80 {lab=GND}
N 1080 -80 1080 -60 {lab=GND}
N 1080 -210 1080 -190 {lab=Vo2}
N 730 -210 760 -210 {lab=Vx}
...
C {ind.sym} 860 -210 1 0 {name=L2
m=1
value=10G
footprint=1206
device=inductor}
C {devices/code_shown.sym} 70 -700 0 0 {name=MODELS only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {devices/noconn.sym} 1050 -400 2 0 {name=l3}
C {devices/lab_wire.sym} 1010 -340 0 0 {name=p12 sig_type=std_logic lab=VSS}
...
C {devices/gnd.sym} 280 -200 0 0 {name=l5 lab=GND}
C {devices/lab_wire.sym} 280 -300 0 0 {name=p14 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 1210 -460 0 0 {name=p15 sig_type=std_logic lab=Vout}
C {devices/gnd.sym} 1210 -290 0 0 {name=l8 lab=GND}
C {devices/code_shown.sym} 690 -690 0 0 {name=Voltage_sources only_toplevel=true
value="
.param VDD = 1.8
.param VSS = 0
.param Vref = 1.2
...
.param Vout_CM = 0.9
"}
C {devices/vsource.sym} 130 -240 0 0 {name=V8 value=\{VDD\}}
C {devices/gnd.sym} 130 -200 0 0 {name=l12 lab=GND}
C {devices/lab_wire.sym} 130 -300 0 0 {name=p19 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} 210 -240 0 0 {name=V9 value=\{VSS\}}
C {devices/gnd.sym} 210 -200 0 0 {name=l13 lab=GND}
C {devices/lab_wire.sym} 210 -300 0 0 {name=p20 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 840 -490 0 0 {name=p21 sig_type=std_logic lab=V-}
C {devices/lab_wire.sym} 760 -360 0 0 {name=p22 sig_type=std_logic lab=V-}
C {devices/lab_wire.sym} 840 -440 0 0 {name=p23 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 1010 -380 0 0 {name=p5 sig_type=std_logic lab=Vref}
C {simulator_commands.sym} 990 -690 0 0 {name=COMMANDS1
simulator=ngspice
only_toplevel=false 
value="
.control
...
write error_amplifier_N_input_v2_TB_ac.raw
...
.endc
"}
C {devices/vsource.sym} 350 -240 0 0 {name=V2 value=\{Vref\}}
C {devices/gnd.sym} 350 -200 0 0 {name=l1 lab=GND}
C {devices/lab_wire.sym} 350 -300 0 0 {name=p1 sig_type=std_logic lab=Vref}
C {devices/lab_wire.sym} 810 -210 0 0 {name=p2 sig_type=std_logic lab=Vx}
C {vcvs.sym} 1080 -160 0 1 {name=E1 value=1}
C {devices/gnd.sym} 1080 -60 0 0 {name=l4 lab=GND}
...
C {gf180/error_amplifier_N_input_v2/xschem/error_amplifier_N_input_v2.sym} 1030 -460 0 0 {name=x1}
C {devices/launcher.sym} 150 -580 0 0 {name=h1
descr="Save & Netlist & sim" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {launcher.sym} 150 -530 0 0 {name=h2
descr="Annotate OP"
