...
.control
  ...
  dowhile run < mc_runs
    ...
    *plot vout_sw
    ...
    let run = run + 1
    *op
    write error_amplifier_N_input_v2_TB_offset_v2.raw
    reset
  end    $ loop ends here
...
C {devices/vsource.sym} 670 -400 1 0 {name=V2 value=-0.3}
C {gf180/error_amplifier_N_input_v1/xschem/error_amplifier_N_input_v1.sym} 780 -220 0 0 {name=x1}
