...
write error_amplifier_N_input_v1_TB_cmrr.raw
...
C {launcher.sym} 150 -400 0 0 {name=h4
descr="Annotate OP"
tclcommand="set show_hidden_texts 1; xschem annotate_op"}
C {devices/lab_wire.sym} 650 -310 2 0 {name=p16 sig_type=std_logic lab=Vin}
C {gf180/error_amplifier_N_input_v1/xschem/error_amplifier_N_input_v1.sym} 810 -340 0 0 {name=x1}
