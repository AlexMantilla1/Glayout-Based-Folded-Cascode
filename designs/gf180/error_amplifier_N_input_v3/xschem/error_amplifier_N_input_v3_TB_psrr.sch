...
N 980 -330 980 -280 {
lab=Vout}
N 290 -90 290 -80 {lab=GND}
N 290 -180 290 -150 {lab=Vin}
N 590 -360 690 -360 {
lab=V-}
...
N 930 -330 930 -70 {lab=Vout}
N 820 -70 930 -70 {lab=Vout}
N 590 -300 590 -70 {lab=V-}
N 590 -70 760 -70 {lab=V-}
N 590 -360 590 -300 {lab=V-}
N 640 -300 690 -300 {lab=Vin}
N 690 -360 710 -360 {lab=V-}
N 690 -310 690 -300 {lab=Vin}
N 690 -310 710 -310 {lab=Vin}
N 370 -90 370 -80 {lab=GND}
N 370 -180 370 -150 {lab=Vref}
C {capa.sym} 640 -330 0 0 {name=C3
m=1
value=10G
footprint=1206
device="ceramic capacitor"}
C {ind.sym} 790 -70 1 0 {name=L2
m=1
value=10G
footprint=1206
device=inductor}
...
"}
C {devices/noconn.sym} 820 -270 0 1 {name=l3}
C {devices/lab_wire.sym} 780 -210 0 0 {name=p12 sig_type=std_logic lab=VSS}
...
C {devices/gnd.sym} 290 -80 0 0 {name=l4 lab=GND}
C {devices/lab_wire.sym} 290 -180 0 0 {name=p14 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 980 -330 0 0 {name=p15 sig_type=std_logic lab=Vout}
C {devices/gnd.sym} 980 -160 0 0 {name=l8 lab=GND}
C {simulator_commands.sym} 760 -560 0 0 {name=COMMANDS1
simulator=ngspice
only_toplevel=false 
value="
.control
...
write error_amplifier_N_input_v3_TB_psrr.raw
...
meas ac Aps find vout_mag at=1e2
...
.param Vin = 1.2
"}
C {devices/vsource.sym} 130 -120 0 0 {name=V8 value="\{VDD\} AC 1"}
...
C {devices/lab_wire.sym} 590 -360 0 0 {name=p3 sig_type=std_logic lab=V-}
C {devices/lab_wire.sym} 640 -300 2 0 {name=p21 sig_type=std_logic lab=Vin}
C {devices/lab_wire.sym} 780 -250 0 0 {name=p5 sig_type=std_logic lab=Vref}
C {devices/vsource.sym} 370 -120 0 0 {name=V1 value=\{Vref\}}
C {devices/gnd.sym} 370 -80 0 0 {name=l9 lab=GND
value=\{Vref\}}
C {devices/lab_wire.sym} 370 -180 0 0 {name=p6 sig_type=std_logic lab=Vref
value=\{Vref\}}
C {gf180/error_amplifier_N_input_v3/xschem/error_amplifier_N_input_v3.sym} 800 -330 0 0 {name=x1}
C {devices/launcher.sym} 180 -470 0 0 {name=h3
descr="Save & Netlist & sim" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {launcher.sym} 180 -410 0 0 {name=h2
descr="Annotate OP"
