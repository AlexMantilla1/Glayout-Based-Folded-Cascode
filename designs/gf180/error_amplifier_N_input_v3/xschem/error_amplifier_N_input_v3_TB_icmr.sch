...
S {}
E {}
T {The measurerror_amplifier_N_input_v3ent for this test must be checked. 
...
However, measurerror_amplifier_N_input_v3ent is not okay today.
...
write error_amplifier_N_input_v3_TB_icmr.raw
...
.param Vout_CM = 1.65
"}
C {gf180/error_amplifier_N_input_v3/xschem/error_amplifier_N_input_v3.sym} 870 -290 0 0 {name=x1}
C {devices/launcher.sym} 180 -430 0 0 {name=h3
descr="Save & Netlist & sim" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {launcher.sym} 180 -370 0 0 {name=h2
descr="Annotate OP"
