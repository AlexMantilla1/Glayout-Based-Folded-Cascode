...
.control
  ...
  dowhile run < mc_runs
    ...
    *plot vout_sw
    ...
    let run = run + 1
    *op
    write error_amplifier_N_input_v3_TB_offset_v2.raw
    reset
  end    $ loop ends here
...
C {gf180/error_amplifier_N_input_v3/xschem/error_amplifier_N_input_v3.sym} 810 -300 0 0 {name=x1}
C {devices/launcher.sym} 190 -430 0 0 {name=h3
